...
Highlights:
	...
	4. Calculates valuable KPIs:
	   - recency (monts since last order)
	   - average order value
...
WITH base_query AS(
/*-------------------------------------------------------------
1) Base Query & Transformation: Retrieves core columns from tables
---------------------------------------------------------------*/
SELECT 
	f.order_number,
	f.product_key,
...
/* 
==================================================================================================
Once the view for the above report is created, end user can utilize to draw the insights from it
==================================================================================================
*/
